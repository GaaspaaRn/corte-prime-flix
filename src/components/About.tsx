    ...
    <div className="container mx-auto px-4">
      ...
      <div className="text-center mt-16 p-8 bg-gradient-card rounded-lg border border-border/50">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="shadow-glow" onClick={() => window.open(`https://wa.me/5547988984877?text=${encodeURIComponent('Olá! Gostaria de agendar uma visita à Barbearia Premium.')}`, '_blank')}>
            Agendar Visita
          </Button>
