...
const AssinaturaFAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "O Plano Premium Cabelo e Barba (R$ 164,90) é perfeito para quem faz cabelo e barba. Fazendo as contas, se você for 2+ vezes no mês, o plano já se paga."
    },
    {
      question: "Quais são as opções mais acessíveis?",
      answer: "Temos o Plano Premium Cabelo por R$ 104,90 e o Plano Premium Barba por R$ 94,90. Ambos com acesso ilimitado ao serviço escolhido."
    }
  ];
